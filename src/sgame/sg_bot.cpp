...
{
#ifdef UNREALARENA
	G_BotListTeamNames( ent, QQ( N_( "^3Q bot names:" ) ), TEAM_Q, "^1*" );
	G_BotListTeamNames( ent, QQ( N_( "^3U bot names:" ) ), TEAM_U, "^4*" );
#else
...
#ifdef UNREALARENA
		for ( t = TEAM_NONE + 1; t < NUM_TEAMS; ++t )
#else
